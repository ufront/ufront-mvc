package ufront.web.result;
	...
	**/
	class DetoxResult<W:Widget> extends ActionResult {
		...
		/** The layout used for the current request. This is either set from the constructor, or instantiated during `executeResult` using the context injector. Readonly. **/
