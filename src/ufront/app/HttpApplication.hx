...
class HttpApplication
{
	...
	**/
	...
	/** An alias for `InjectionTools.injectValue( application.injector, cl, val, named )` **/
	...
	/** An alias for `InjectionTools.injectClass( application.injector, cl, cl2, singleton, named )` **/
